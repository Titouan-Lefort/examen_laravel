            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="text-lg"><strong>{{ __('Places disponibles supplémentaires:') }}</strong> {{ $remainingPlaces }}</p>
                    </div>
                    ...
                    <div class="mt-6">
                        <form action="{{ route('reservation.update', $reservation->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                @enderror
                                <p class="text-sm text-gray-500 mt-1">{{ __('Vous pouvez augmenter jusqu\'à :count personnes au total.', ['count' => $remainingPlaces + $reservation->nombre_personnes]) }}</p>
                            </div>

                            <div class="flex items-center justify-end mt-4">
                                <a href="{{ route('reservation.my') }}" class="text-gray-600 hover:text-gray-900 mr-4">{{ __('Annuler') }}</a>
