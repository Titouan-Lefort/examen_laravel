            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="mb-6">
                        ...
                        <p class="text-lg"><strong>Adresse:</strong> {{ $salle->adresse }}</p>
                        <p class="text-lg"><strong>Capacité totale:</strong> {{ $salle->capacite }} personnes</p>
                    </div>
                    ...
                    <div class="mt-6">
                        <form action="{{ route('reservation.store') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="date_reservation" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Date</label>
                            ...
                            <div class="mb-4">
                                <label for="heure_debut" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Heure</label>
