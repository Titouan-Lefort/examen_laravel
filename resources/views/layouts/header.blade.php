    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @auth
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('reservation.index')" :active="request()->routeIs('reservation.index') || request()->routeIs('reservation.create') || request()->routeIs('reservation.show')">
                            {{ __('Reservations') }}
                        </x-nav-link>
                        <x-nav-link :href="route('reservation.my')" :active="request()->routeIs('reservation.my') || request()->routeIs('reservation.edit')">
                            {{ __('Mes Réservations') }}
                        </x-nav-link>
                    </div>
                @endauth
                ...
                @else
                    <div class="space-x-4">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="text-sm text-gray-700 underline dark:text-gray-500">Register</a>
                        @endif
                    </div>
                @endauth
            </div>
