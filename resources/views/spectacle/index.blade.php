                        ...
                        <tbody class="text-gray-600 dark:text-gray-200 text-sm font-light">
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="py-3 px-6 text-left">
                                    {{ $spectacle->salle->nom_salle }}
                                </td>
                                <td class="py-3 px-6 text-left">
                                    {{ number_format($spectacle->prix, 2) }} €
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <a href="{{ route('spectacle.edit', $spectacle->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
